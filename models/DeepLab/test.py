...
flags.DEFINE_string('vis_split', 'eval',
...
flags.DEFINE_integer('max_number_of_iterations', 100,
...
def main(unused_argv):
  ...
  with g.as_default():
    ...
    predictions = tf.where(tf.greater(predictions, 50),
                tf.scalar_mul(255, tf.ones_like(predictions)), tf.zeros_like(predictions))
